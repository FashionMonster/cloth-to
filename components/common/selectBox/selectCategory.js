...
//         name={props.name}
//         id={props.id}
//         className={`w-${props.width} h-8 border border-solid rounded-sm border-gray-400 disabled:bg-gray-100 disabled:text-black disabled:text-opacity-100 disabled:bg-opacity-100`}
//         ref={props.register}
